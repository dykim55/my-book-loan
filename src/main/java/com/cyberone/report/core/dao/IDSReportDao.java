...
public class IDSReportDao extends BaseDao {

	public IDSReportDao(DB promDb, DB rptDb)	{
		super(promDb, rptDb);
	}

	public List<DBObject> IDS_SessionLogMonth(int assetCode, String sEndDay) throws Exception {
		
		StartTimeCheck("IDS_SessionLogMonth");
		...
		try {
			...
			DBCollection dbCollection = rptDb.getCollection("IDS_" + assetCode + "_MON");
	...
	public List<DBObject> IDS_SessionLogDay(int assetCode, String sStartDay, String sEndDay) throws Exception {
		
		StartTimeCheck("IDS_SessionLogDay");
		...
		try {
			...
			DBCollection dbCollection = rptDb.getCollection("IDS_" + assetCode + "_DY");
	...
	public List<DBObject> IDS_TopInfoMonth(int assetCode, String sEndDay, String sAction, int nField, int nLimit) throws Exception {
		
		StartTimeCheck("IDS_TopInfoMonth");
	...
	public List<DBObject> IDS_Top10EventChange(int assetCode, String sStartDay, String sEndDay, String sAction, List<String> events) throws Exception {
		
		StartTimeCheck("IDS_Top10EventChange");
	...
	public List<DBObject> IDS_DataVariation(int assetCode, String sEndDay, String sAction, int nField) throws Exception {
		
		StartTimeCheck("IDS_DataVariation");
	...
	public List<DBObject> IDS_Top10Condition_1st(int assetCode, String sEndDay, String sAction, int nField, String sField) throws Exception {
		
		StartTimeCheck("IDS_Top10Condition_1st");
	...
	public List<DBObject> IDS_Top10Condition_2nd(int assetCode, String sEndDay, String sAction, int nField, String sField1, String sField2) throws Exception {
		
		StartTimeCheck("IDS_Top10Condition_2st");
	...
	public List<DBObject> IDS_PrevMonthInfo(int assetCode, String sEndDay, String sAction, int nField, List<String> lstFields) throws Exception {
		
		StartTimeCheck("IDS_PrevMonthInfo");
