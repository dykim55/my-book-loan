...
<span id="formTitle" style="display:none;">방화벽(FW) 월간보고서 설정</span>
...
<div class="mb10">
  <input type="checkbox" id="opt1" name="opt1"><label for="opt1"> 외부에서 내부로의 전체 세션 로그 발생추이 (차트, 표)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt2" name="opt2"><label for="opt2"> 외부에서 내부로의 허용 세션 로그 발생추이 (차트)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt3" name="opt3"><label for="opt3"> 외부에서 내부로의 차단 세션 로그 발생추이 (차트)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt4" name="opt4"><label for="opt4"> 내부에서 외부로의 전체 세션 로그 발생추이 (차트, 표)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt5" name="opt5"><label for="opt5"> 내부에서 외부로의 허용 세션 로그 발생추이 (차트)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt6" name="opt6"><label for="opt6"> 내부에서 외부로의 차단 세션 로그 발생추이 (차트)</label>
</div>


<h2 class="mb10">출발지IP TOP#N</h2>
<div class="mb10">
  <input type="checkbox" id="opt7" name="opt7"><label for="opt7"> 외부에서 내부로의 전체 세션로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    <input type="radio" name="rd7" id="rd7-1" value="1" checked><label for="rd7-1"> TOP 10</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd7" id="rd7-2" value="2"><label for="rd7-2"> TOP 20</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd7" id="rd7-3" value="3"><label for="rd7-3"> TOP 30</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt8" name="opt8"><label for="opt8"> 외부에서 내부로의 허용 세션로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt9" name="opt9"><label for="opt9"> 외부에서 내부로의 차단 세션로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt10" name="opt10"><label for="opt10"> 내부에서 외부로의 전체 세션로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt11" name="opt11"><label for="opt11"> 내부에서 외부로의 허용 세션로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt12" name="opt12"><label for="opt12"> 내부에서 외부로의 차단 세션로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt13" name="opt13"><label for="opt13"> 외부에서 내부로의 전체 세션로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd13" id="rd13-3" value="3"><label for="rd13-3"> TOP 30</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt14" name="opt14"><label for="opt14"> 외부에서 내부로의 허용 세션로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd14" id="rd14-3" value="3"><label for="rd14-3"> TOP 30</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt15" name="opt15"><label for="opt15"> 외부에서 내부로의 차단 세션로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt16" name="opt16"><label for="opt16"> 내부에서 외부로의 전체 세션로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt17" name="opt17"><label for="opt17"> 내부에서 외부로의 허용 세션로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt18" name="opt18"><label for="opt18"> 내부에서 외부로의 차단 세션로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd18" id="rd18-3" value="3"><label for="rd18-3"> TOP 30</label>
  </div>
</div>

<h2 class="mb10">서비스 TOP#N</h2>
<div class="mb10">
  <input type="checkbox" id="opt19" name="opt19"><label for="opt19"> 외부에서 내부로의 허용 세션로그 & 서비스 TOP10 (차트, 표)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt20" name="opt20"><label for="opt20"> 외부에서 내부로의 차단 세션로그 & 서비스 TOP10 (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt21" name="opt21"><label for="opt21"> 외부에서 내부로의 차단 세션로그 & 서비스 TOP10 상세 (차트)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt22" name="opt22"><label for="opt22"> 내부에서 외부로의 허용 세션로그 & 서비스 TOP10 (차트, 표)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt23" name="opt23"><label for="opt23"> 내부에서 외부로의 차단 세션로그 & 서비스 TOP10 (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt24" name="opt24"><label for="opt24"> 내부에서 외부로의 차단 세션로그 & 서비스 TOP10 상세 (차트)</label>
</div>
