    ...
    return {
        ...
        init : function(Dlg, slctRow) {
            ...
            $("#apply_selected_asset").jqGrid({
                datatype: "jsonstring",
                colNames:["Id", "Level", "formCode", "", "적용된(선택된) 자산그룹", "그룹명"],
                colModel:[
            ...
            $("#apply_asset").jqGrid({
            	url:  "/report/groupApplyList",
            	datatype: "json",
                colNames:["Id", "Level", "적용가능한 자산그룹명", "적용양식",""],
                colModel:[
                    {name:'id', index:'id', width:0, hidden:true, key:true},
                    {name:'level', index:'level', width:0, hidden:true},
                    ...
                    {name:'applyForm',     index:'applyForm',     width:360, align:'left', fixed:true, title:false, sortable: false},
                    {name:'applyFormCode', index:'applyFormCode', width:0, hidden:true},
                ],
                height: 535,
                gridview: true,
                ...
                beforeSelectRow: function (rowid, e) {
                    ...
                    if (localData.level==2 && localState) {
