...
<div class="mb10">
  <input type="checkbox" id="opt4" name="opt4"><label for="opt4"> 외부에서 내부로의 전체 세션 로그 발생추이 (차트)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt7" name="opt7"><label for="opt7"> 내부에서 외부로의 전체 세션 로그 발생추이 (차트)</label>
</div>
