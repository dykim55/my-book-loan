...
FORM_OPTION = (function() {
    ...
    return {
        ...
        init : function(chkData, formData, assetCode) {
            ...
            if (chkData.etc) {
	            $.each(chkData.etc.split(','), function(idx, pack) {
...
<span id="formTitle" style="display:none;">방화벽(FW) 일일보고서 설정</span>
...
<div class="mb10">
  ...
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd20" id="rd20-3" value="3"><label for="rd20-3"> TOP 30</label>
  </div>
</div>
...
<div class="mb10">
  ...
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd21" id="rd21-3" value="3"><label for="rd21-3"> TOP 30</label>
  </div>
</div>
