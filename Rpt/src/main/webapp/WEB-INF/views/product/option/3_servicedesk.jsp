...
<span id="formTitle" style="display:none;">관제실적 월간보고서 설정</span>
...
<div class="mb10">
  <input type="checkbox" id="opt9" name="opt9"><label for="opt9"> 침해위협탐지 추이</label>
  <div style="margin-left: 20px;" class="subpanel">
    <input type="radio" name="rd9" id="rd9-1" value="1" checked><label for="rd9-1"> 최근 1개월 (차트)</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd9" id="rd9-2" value="2"><label for="rd9-2"> 최근 6개월 (차트)</label>
  </div>
</div>
...
<div class="mb10">
  <input type="checkbox" id="opt13" name="opt13"><label for="opt13"> 공격자IP 침해시도 추이</label>
  <div style="margin-left: 20px;" class="subpanel">
    <input type="radio" name="rd13" id="rd13-1" value="1" checked><label for="rd13-1"> 최근 1개월 (차트)</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd13" id="rd13-2" value="2"><label for="rd13-2"> 최근 6개월 (차트)</label>
  </div>
</div>
...
<div class="mb10">
  <input type="checkbox" id="opt15" name="opt15"><label for="opt15"> 공격지별 침해시도 추이</label>
  <div style="margin-left: 20px;" class="subpanel">
    <input type="radio" name="rd15" id="rd15-1" value="1" checked><label for="rd15-1"> 최근 1개월 (차트)</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd15" id="rd15-2" value="2"><label for="rd15-2"> 최근 6개월 (차트)</label>
  </div>
</div>
