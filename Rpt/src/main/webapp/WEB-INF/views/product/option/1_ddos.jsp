...
FORM_OPTION = (function() {
    ...
    return {
        title : function() {
            ...
            return { "data": data, "etc": undefined };
        },
        formData : function() {
            return { formCode:_formCode, formType:_formType, reportType:_reportType, assetCode:_assetCode};
        },
        init : function(chkData, formData, assetCode) {
        	_data = chkData.data;
        	
            if (formData) {
                _formCode = formData.formCode;
                _formType = formData.formType;
                _reportType = formData.reportType;
            }
...
<span id="formTitle" style="display:none;">DDoS 일일보고서 설정</span>
...
<div class="mb10">
  ...
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd3" id="rd3-2" value="2"><label for="rd3-2"> 최근 3일 (차트, 표)</label>
  </div>
</div>
...
<div class="mb10">
  ...
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd4" id="rd4-2" value="2"><label for="rd4-2"> 최근 3일 (차트, 표)</label>
  </div>
</div>
...
<div class="mb10">
  ...
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd6" id="rd6-2" value="2"><label for="rd6-2"> 최근 3일 (차트, 표)</label>
  </div>
</div>
...
<div class="mb10">
  ...
  <div style="margin-left: 20px;" class="subpanel">
    <input type="radio" name="rd7" id="rd7-1" value="1" checked><label for="rd7-1"> 해당일 (차트)</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd7" id="rd7-2" value="2"><label for="rd7-2"> 최근 3일 (차트, 표)</label>
  </div>
</div>
